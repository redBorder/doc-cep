...
Ventana deslizante que mantiene los últimos elementos recibidos.
...
Ventana deslizante que emite los eventos como un lote a la llegada del i-ésimo evento.
...
Ventana deslizante que trabaja con el tiempo proporcionado por el flujo de eventos de entrada en lugar de utiliza la fecha de la máquina.
